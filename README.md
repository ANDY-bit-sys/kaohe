...
文件与技术验证已补齐；尚需本人复核电路图和计算、独立讲解两处代码逻辑、亲自运行 AI 错误复现，并完成群内收集表提交。[讲解练习](docs/self-review.md)可用于准备。
...
GitHub 两步验证：**已开启**，本人于 2026-09-07 确认。可在 [GitHub 密码与身份验证设置](https://github.com/settings/security) 查看和管理。验证码、密钥和恢复码不写入仓库。
